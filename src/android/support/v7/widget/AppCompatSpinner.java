 ...
 */
@TargetApi(Build.VERSION_CODES.JELLY_BEAN) public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    @SuppressLint("NewApi") public void setPopupBackgroundDrawable(Drawable background) {
        if (mPopup != null) {
